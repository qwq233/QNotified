...
public class AboutActivity extends IphoneTitleBarActivityCompat {
    ...
    public boolean doOnCreate(Bundle bundle) {
        ...
        ll.addView(subtitle(this, "此模块目前承认的APP发布渠道为 Github 上本项目的 Releases 和 Xposed Installer 里的模块下载 ,也可从https://github.com/qwq233/QNotified 获取源码自行编译, 如果您是在其他渠道下载的话请自己注意安全.\n Copyright (C) 2019-2020 cinit@github"));
